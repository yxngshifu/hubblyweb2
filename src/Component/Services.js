...
function Services() {
  ...
  <h1 className="lg:text-4xl sm:text-xl font-bold font-MuseoModerno">API Integration Services</h1>
 ...
 <div className="sm:px-10  lg:px-80 flex flex-col items-start mb-4">
  <h1 className="lg:text-4xl sm:text-xl font-bold font-MuseoModerno">Product Discovery Phase</h1>
  <p className=' sm:text-xs lg:text-sm font-Raleway'>Identify key objectives and map out a roadmap for success.</p>
  <hr className="border-t-4 border-gray-400 my-2 w-full" />
</div>

 <div className=" sm:px-10 lg:px-80 flex flex-col items-start mb-4">
  <h1 className="lg:text-4xl sm:text-xl font-bold font-MuseoModerno">Software Re-engineering</h1>
  <p className='sm:text-xs lg:text-sm font-Raleway'>Upgrade and optimize your existing software for enhanced perfomance.</p>
  <hr className="border-t-4 border-gray-400 my-2 w-full" />
</div>

<div className="sm:px-10  lg:px-80 flex flex-col items-start mb-4">
  <h1 className="lg:text-4xl sm:text-l font-bold font-MuseoModerno">Application Modernization Services</h1>
  <p className='sm:text-xs lg:text-sm font-Raleway'>Stay ahead with cutting-edge technology and user-centric design.</p>
  <hr className="border-t-4 border-gray-400 my-2 w-full" />
</div>

<div className=" sm:px-10 lg:px-80 flex flex-col items-start mb-4">
  <h1 className="lg:text-4xl sm:text-xl font-bold font-MuseoModerno">Software Product Development</h1>
  <p className='sm:text-xs lg:text-sm font-Raleway'>From concept to execution, we bring your ideas to life.</p>
  <hr className="border-t-4 border-gray-400 my-2 w-full" />
</div>

<div className=" sm:px-10 lg:px-80 flex flex-col items-start mb-4">
  <h1 className="  lg:text-4xl sm:text-xl font-bold font-MuseoModerno">CTO as a Service for Start-Ups</h1>
...
<div className=" sm:px-10 lg:px-80 flex flex-col items-start mb-4 pb-12">
  <h1 className="lg:text-4xl sm:text-xl font-bold font-MuseoModerno">Offshore Development Services</h1>
